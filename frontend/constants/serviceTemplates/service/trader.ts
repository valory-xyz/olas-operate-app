...
export const PREDICT_SERVICE_TEMPLATE: ServiceTemplate = {
  hash: 'bafybeibytzjwtjqasezhuxrgkvrp3jgg7b56mpgeh5czbu4eblm7uvya4a',
  service_version: 'v0.31.2-rc2',
  agent_release: {
    is_aea: true,
    repository: {
      owner: 'valory-xyz',
  ...
  env_variables: {
    ...
    IRRELEVANT_TOOLS: {
      ...
      description: '',
      value:
        '["native-transfer","prediction-online-lite","claude-prediction-online-lite","prediction-online-sme-lite","prediction-request-reasoning-lite","prediction-request-reasoning-claude-lite","prediction-offline-sme","deepmind-optimization","deepmind-optimization-strong","openai-gpt-3.5-turbo","openai-gpt-3.5-turbo-instruct","openai-gpt-4","openai-text-davinci-002","openai-text-davinci-003","prediction-online-sum-url-content","prediction-online-summarized-info","stabilityai-stable-diffusion-512-v2-1","stabilityai-stable-diffusion-768-v2-1","stabilityai-stable-diffusion-v1-5","stabilityai-stable-diffusion-xl-beta-v2-2-2","prediction-url-cot-claude","prediction-url-cot","resolve-market-reasoning-gpt-4.1","gemini-2.5-flash","anthropic-claude-opus-4-5-latest"]',
      provision_type: EnvProvisionType.FIXED,
    },
    GENAI_API_KEY: {
      name: 'Gemini API Key',
...
export const PREDICT_POLYMARKET_SERVICE_TEMPLATE: ServiceTemplate = {
  hash: 'bafybeigah2qrjfzuj4l77eelaim4pok6onpfnlso2xc47xyi3bqaiqjkza',
  service_version: 'v0.31.1-rc3',
  agent_release: {
    is_aea: true,
    repository: {
      owner: 'valory-xyz',
