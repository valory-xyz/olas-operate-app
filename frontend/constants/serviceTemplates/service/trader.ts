...
export const PREDICT_SERVICE_TEMPLATE: ServiceTemplate = {
  hash: 'bafybeigtucicbo5p4ukvp2462nfzwx2uye4b6opc6tkibpbjpvs3wjrliq',
  service_version: 'v0.31.3',
  agent_release: {
    is_aea: true,
    repository: {
      owner: 'valory-xyz',
  ...
  env_variables: {
    ...
    IRRELEVANT_TOOLS: {
      ...
      description: '',
      value:
        '["native-transfer","prediction-online-lite","claude-prediction-online-lite","prediction-online-sme-lite","prediction-request-reasoning-lite","prediction-request-reasoning-claude-lite","prediction-offline-sme","deepmind-optimization","deepmind-optimization-strong","openai-gpt-3.5-turbo","openai-gpt-3.5-turbo-instruct","openai-gpt-4","openai-text-davinci-002","openai-text-davinci-003","prediction-online-sum-url-content","prediction-online-summarized-info","stabilityai-stable-diffusion-512-v2-1","stabilityai-stable-diffusion-768-v2-1","stabilityai-stable-diffusion-v1-5","stabilityai-stable-diffusion-xl-beta-v2-2-2","prediction-url-cot-claude","prediction-url-cot","resolve-market-reasoning-gpt-4.1","gemini-2.5-flash","anthropic-claude-opus-4-5-latest","echo","profit_pulse","claude-prediction-online","prediction-request-rag-claude","prediction-online-sme"]',
      provision_type: EnvProvisionType.FIXED,
    },
    GENAI_API_KEY: {
      name: 'Gemini API Key',
...
export const PREDICT_POLYMARKET_SERVICE_TEMPLATE: ServiceTemplate = {
  hash: 'bafybeiczi2ootkzsdd2q2okxryfcq4uwuplzq4km4rrquqizliud6p5mpm',
  service_version: 'v0.31.5',
  agent_release: {
    is_aea: true,
    repository: {
      owner: 'valory-xyz',
  ...
  env_variables: {
    ...
    IRRELEVANT_TOOLS: {
      ...
      description: '',
      value:
        '["native-transfer","prediction-online-lite","claude-prediction-online-lite","prediction-online-sme-lite","prediction-request-reasoning-lite","prediction-request-reasoning-claude-lite","prediction-offline-sme","deepmind-optimization","deepmind-optimization-strong","openai-gpt-3.5-turbo","openai-gpt-3.5-turbo-instruct","openai-gpt-4","openai-text-davinci-002","openai-text-davinci-003","prediction-online-sum-url-content","prediction-online-summarized-info","stabilityai-stable-diffusion-512-v2-1","stabilityai-stable-diffusion-768-v2-1","stabilityai-stable-diffusion-v1-5","stabilityai-stable-diffusion-xl-beta-v2-2-2","prediction-url-cot-claude","prediction-url-cot","resolve-market-reasoning-gpt-4.1","echo","profit_pulse","claude-prediction-online","prediction-request-rag-claude","prediction-online-sme"]',
      provision_type: EnvProvisionType.FIXED,
    },
    GENAI_API_KEY: {
      name: 'Gemini API Key',
