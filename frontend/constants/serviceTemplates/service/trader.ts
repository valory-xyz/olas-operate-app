...
export const PREDICT_SERVICE_TEMPLATE: ServiceTemplate = {
  hash: 'bafybeihv6e732ly3lfweqepghlurjddqxgfpsj63bpmrhqdobz3b2sxz2y',
  service_version: 'v0.40.5',
  agent_release: {
    is_aea: true,
    repository: {
      owner: 'valory-xyz',
...
export const PREDICT_POLYMARKET_SERVICE_TEMPLATE: ServiceTemplate = {
  hash: 'bafybeihgaacsrfbf7higtvldkjyqzjt45c5r2xtxebdzg4ckjap6ggq5ou',
  service_version: 'v0.40.5',
  agent_release: {
    is_aea: true,
    repository: {
