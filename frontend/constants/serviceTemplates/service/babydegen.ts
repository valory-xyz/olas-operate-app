...
const BASIUS_TEMPLATE_RELEASE: Pick<
  ...
  'hash' | 'service_version' | 'agent_release'
> = {
  hash: 'bafybeiauuasd2lnxgpgo6epcdq5vrzqw7m364ojd64kmy2dxbflvmb5vhe',
  service_version: 'v0.12.9',
  agent_release: {
    is_aea: true,
    repository: {
      owner: 'valory-xyz',
...
const OPTIMUS_TEMPLATE_RELEASE: Pick<
  ...
  'hash' | 'service_version' | 'agent_release'
> = {
  hash: 'bafybeigkqmzkry6ntm267tatsfi4eqcgqmaxm5yle7rscipp4stc37xixe',
  service_version: 'v0.12.9',
  agent_release: {
    is_aea: true,
    repository: {
