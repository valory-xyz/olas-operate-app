...
import { BASIUS_SERVICE_TEMPLATE, MODIUS_SERVICE_TEMPLATE, OPTIMUS_SERVICE_TEMPLATE } from '.';
...
const AGENTS_FUN_COMMON_TEMPLATE: Pick<
  ...
  | 'agent_release'
> = {
  hash: 'bafybeid3c6w2xybipfrtossjori6cchcxyvfvukr2jquxlla57qev737ty',
  image:
