export const MECH_MARKETPLACE_V2_ABI = [
  {
    inputs: [
      { internalType: 'address', name: '_serviceRegistry', type: 'address' },
      { internalType: 'address', name: '_karma', type: 'address' },
    ],
  ...
  {
    inputs: [{ internalType: 'bytes32', name: 'paymentType', type: 'bytes32' }],
  ...
  {
    inputs: [
      { internalType: 'bytes[]', name: 'requestDatas', type: 'bytes[]' },
      { internalType: 'uint256', name: 'maxDeliveryRate', type: 'uint256' },
      { internalType: 'bytes32', name: 'paymentType', type: 'bytes32' },
      { internalType: 'address', name: 'priorityMech', type: 'address' },
      { internalType: 'uint256', name: 'responseTimeout', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'address[]', name: 'mechFactories', type: 'address[]' },
  ...
  {
    inputs: [
      { internalType: 'bytes32[]', name: 'paymentTypes', type: 'bytes32[]' },
      { internalType: 'address[]', name: 'balanceTrackers', type: 'address[]' },
    ],
    name: 'setPaymentTypeBalanceTrackers',
    outputs: [],
    stateMutability: 'nonpayable',
