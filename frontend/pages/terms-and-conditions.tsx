...
const Web3AuthTermsAndConditions = () => (
  <>
    ...
    <TermsContainer>
      ...
      <div>
        <Paragraph>
          These &quot;Web3Auth Terms&quot; govern the creation and use of a
          Web3Auth wallet within Pearl. By using this feature, you agree to
          these{' '}
        ...
        <Paragraph>
          <DividedOl>
            <li className="mb-12">
              ...
              <ul>
                <li>
                  <b>&quot;Pearl Wallet&quot;</b> means your account within the
                  Pearl application, including an externally-owned cryptographic
                  wallet, encrypted using a user-defined password, and used to
                  control underlying wallets, including the MasterSafe (see
                  below).
                </li>
                <li>
                  <b>&quot;Web3Auth Wallet&quot;</b> or{' '}
                  <b>&quot;Wallet&quot;</b> means the cryptographic wallet
                  created through{' '}
                  <a target="_blank" href={WEB3AUTH_URL}>
                    Web3Auth&apos;s
                  </a>{' '}
                  key management system for use as a backup to your Pearl
                  Wallet.
                </li>
                <li>
                ...
                <li>
                  <b>&quot;Authentication Provider&quot;</b> means any
                  third-party social login provider whitelisted on Web3Auth
                  (e.g., Google, Apple).
                </li>
                <li>
                  <b>&quot;Key Component&quot;</b> means a portion of the
                  private key generated through Web3Aut&apos;s threshold
                  signature / multi-party computation (MPC) system.
                </li>
                <li>
                  <b>&quot;Valory&quot;</b> means Valory AG, the company
                  developing the open-source application Pearl, available at
            ...
            <li className="mb-12">
              ...
              serve as a <b>backup wallet</b> for your Pearl Wallet, allowing
              you to re-gain access in case you lose access to your primary
              Pearl Wallet.
            </li>
            <li className="mb-12">
              <Title level={5} className="font-weight-600 mt-0 mb-8">
              ...
              <ul>
                ...
                <li>
                  ...
                  Component is derived from your login method. Another is held
                  by Web3Auth&apos;s secure infrastructure. Both are required
                  for signing transactions.
                </li>
                <li>
                  Once created, your Wallet&apos;s <b>public address</b> is
                  added as a backup signer to your MasterSafe via Web3Auth.
                </li>
              </ul>
            </li>
            <li className="mb-12">
              ...
              <ul>
                <li>
                  The Wallet is <b>semi-custodial</b>: you hold one Key
                  Component; Web3Auth holds another.
                </li>
                <li>
                ...
                <li>
                  ...
                  Authentication Provider, and (b) Web3Auth&apos;s
                  infrastructure.
                </li>
                <li>
                  You are solely responsible for safeguarding your login
                  credentials and for all actions authorized through your
                  Wallet. Access requires direct authentication with Web3Auth
                  using the same method originally used to create the Wallet.
                </li>
              </ul>
            </li>
            <li className="mb-12">
              ...
              <ul>
                ...
                <li>
                  Valory guarantees no continuity of Web3Auth&apos;s services
                  and the backup wallet integration into Pearl.
                </li>
              </ul>
            </li>
            <li className="mb-12">
            ...
            <li className="mb-12">
              ...
              conflict-of-law principles. You agree that any dispute arising
              under these Web3Auth Terms shall be subject to the exclusive
              jurisdiction of the competent courts in Zug, Switzerland.
            </li>
          </DividedOl>
        </Paragraph>
      </div>
        ...
        <Paragraph>
          <ul>
            ...
            <li>
              ...
              the &quot;Conditions&quot;, and where there is doubt between the
              two texts, the Valory Terms shall control.
            </li>
            <li>
