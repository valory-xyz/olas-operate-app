...
import { validateTwitterCredentials } from '@/components/SetupPage/SetupYourAgent/shared/validations';
import { useElectronApi } from '@/hooks/useElectronApi';

import { validateGeminiApiKey, ValidationStatus } from '../common/validations';

export type AgentsFunFieldValues = {
...
export const useMemeFormValidate = () => {
  ...
  const handleValidate = useCallback(
    async (values: AgentsFunFieldValues) => {
